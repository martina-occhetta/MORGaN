...
def parse_args():
    ...
    parser.add_argument(
        "-data",
        "--dataset",
        help="the dataset name (default: CPDB_cdgps)",
        dest="dataset",
        default="CPDB_cdgps",
        type=str,
    )
...
def main(args):
    ...
    for run_idx, seed in enumerate(seeds):
        ...
        for epoch in range(1, args["epochs"] + 1):
            ...
            _, val_loss, val_acc, val_auroc, val_aupr, val_f1 = evaluate(
                val_mask, val_label
            )
        ...
        pred, test_loss, test_acc, test_auc, test_aupr, test_f1 = evaluate(
